...
export const projectsIntro = 'Below are a bunch of my projects. Some of them are still being worked on and some of them are finished. I also included some projects that I am working on with others.'
